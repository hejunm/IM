 ...
 */
- (void)connectWithParam:(HESocketConnectParam *)connectParam;
 ...
 *  @param err 错误原因
 */
- (void)didDisconnect:(id<HESocketConnectionDelegate>)con withError:(NSError *)err;
 ...
 */
- (void)didConnect:(id<HESocketConnectionDelegate>)con toHost:(NSString *)host port:(uint16_t)port;
 ...
 */
- (void)didRead:(id<HESocketConnectionDelegate>)con withData:(NSData *)data tag:(long)tag;
 ...
 */
//- (void)didReceived:(id<HESocketConnectionDelegate>)con withPacket:(id<RHDownstreamPacket>)packet;
