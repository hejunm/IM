 ...
 *  搜索顺序
 */
typedef NS_ENUM(NSInteger,HEMessageSearchOrder) {
    /**
     *  从新消息往旧消息查询
     */
    HEMessageSearchOrderDesc       =   0,
    
    /**
     *  从旧消息往新消息查询
     */
    HEMessageSearchOrderAsc        =   1,
};

@interface HEMessageSearchOption : NSObject
 ...
 *  检索顺序
 */
@property (nonatomic,assign)    HEMessageSearchOrder order;
...
@interface HEHistoryMessageSearchOption : NSObject
 ...
 */
@property (nullable,nonatomic,strong)HEMessage *currentMessage;
